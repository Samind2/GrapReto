...
ReactDOM.createRoot(document.getElementById("root")).render(
  <React.StrictMode>  {/* เริ่มต้นการ render ใน StrictMode เพื่อให้แสดง Warning เมื่อมีการใช้ API ที่ไม่ปลอดภัย */}
    <Navbar />  {/* เรียกใช้ Component Navbar เพื่อแสดงบาร์เนวิเกต */}
    <RouterProvider router={router} />  {/* ใช้ RouterProvider เพื่อให้ router ที่นำเข้ามาจัดการเส้นทางในแอปพลิเคชัน */}
